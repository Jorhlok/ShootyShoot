...
public class jSprFrame {
    ...
    public jSprFrame(String key, String img, int tx, int ty, int tw, int th, boolean hf, boolean vf) {
        Name = key;
        Image = img;
        TX = tx;
        TY = ty;
...
//    public void Generate(Map<String,jTexGrid> map) {
//        try {
//            jTexGrid tex = map.get(Image);
